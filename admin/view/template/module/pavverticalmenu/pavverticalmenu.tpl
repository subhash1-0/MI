			...
			<div class="panel-body">
				...
				<!-- ################################w -->
					...
					<div class="tab-pane" id="manage-widgets">
						...
						<a class="btn btn-info btn-modal" href="index.php?route=module/pavverticalmenu/addwidget&token=<?php echo $token; ?>" ><?php echo $objlang->get('text_create_widget'); ?></a>
						<br/><br/>
						<table class="table">
							<tr>	
							...
							<tr>
								...
								<td>
									<a class="btn-action-widget btn-modal" rel="edit" href="index.php?route=module/pavverticalmenu/addwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $objlang->get('text_edit'); ?></a> | 
									<a onclick="return confirm('<?php echo $objlang->get('text_confirm_delete');?>');"	rel="edit" href="index.php?route=module/pavverticalmenu/delwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $objlang->get('text_delete'); ?></a>
								</td>
							<?php } ?>
							</tr>
							<?php } ?>
